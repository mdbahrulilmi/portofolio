    ...
    <section className="relative min-h-[90vh] flex items-center justify-center bg-zinc-50/50 text-zinc-900 overflow-hidden px-6">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="mt-10 flex items-center justify-center">
          <a href={t.buttonLink} className="group relative inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-zinc-900 text-zinc-50 font-medium text-sm transition-all duration-300 hover:bg-zinc-800 hover:shadow-xl hover:shadow-zinc-900/10 active:scale-95 cursor-pointer">
